"""
DEPRECATED: This legacy settings module is not used by the current TECLA architecture.

Pins and AVAILABLE_MODES here are superseded by:
- Runtime hardware setup in `main.py`
- Mode discovery/config via `modes/mode_manager.py` and `config/tecla_config.json`
